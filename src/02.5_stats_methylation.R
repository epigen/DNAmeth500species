...
#calculates stats for different read coverage thresholds
...
for(file in files){
  ...
  meth_data_mean_long=melt(meth_data_mean,id.vars=c("meta","score","consN","mean_diffNts","max_diffNts","min_diffNts"),measure=patterns(".cov", ".meth"),variable.factor=FALSE,variable.name="sample_index",value.name=c("cov","meth"),na.rm=TRUE)
